...
const BlogIntro = () => {
  ...
  let books_text = 'I like to read a lot. And I like to write. So, what will happen if I combine these activities? Exactly – the Books section. Here I talk about the books I read. I mostly focus on non-fiction genre, but sometimes fiction literature will also pop-up. Which books do I read? Read my “Books” blogposts to find out)'
